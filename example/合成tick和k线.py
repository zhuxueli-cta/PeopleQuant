...
quote1.update(pqapi.get_symbol_info(symbol))
#print(quote1)
...
while True:
    ...
    if local_timestamp != quote1.local_timestamp: #新行情推送
        ...
        #print(quote3)
        #print(margin2)
        print(kline.data.tail(1).select(["open""close"]))
        print(kline.data.select(["InstrumentID", "period_start",   "open", "high","low", "close", "Volume","OpenInterest","period" ]).head(5))
