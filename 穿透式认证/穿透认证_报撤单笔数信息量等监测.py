...
print(f'报撤单、信息量统计，报单笔数:{orderrisk["order_count"]}，撤单笔数:{orderrisk["cancel_count"]}，重复报单单笔数:{orderrisk["repeat"]}，开仓单重复报单次数:{orderrisk["repeat_open"]}，平仓单重复报单次数:{orderrisk["repeat_close "]}\n')
